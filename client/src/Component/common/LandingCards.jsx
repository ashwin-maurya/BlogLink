  ...
  return (
    <>
      <article className="break-inside-avoid w-100% p-6 rounded-xl bg-white  dark:bg-darkBgPrimary flex flex-col bg-clip-border shadow-md my-5 group">
          ...
          <div className="flex">
            ...
            <div className="flex flex-col justify-center">
              <div className="flex items-center">
                <a
                  className="inline-block text-lg font-bold mr-2 max-md:text-base dark:text-darkTextMain "
                  href="#"
                >
                  {card.author}
                </a>
        ...
        <h2 className="text-3xl font-bold font-serif   max-md:text-2xl  dark:text-darkTextMain group-hover:text-primaryMain  dark:group-hover:text-secondary">
          {" "}
          {card.label}
        </h2>
        <div className="py-4">
          <a className="flex" href="#">
            <img className="max-w-full rounded-lg" src={card.blog_imgURL} />
          </a>
        </div>
