...
const FeaturedImage = ({blogs,setblog,postid , featuredImage,setfeaturedImage}) => {
...
uploadFeaturedImage(file,postid,setFile,setfeaturedImage)
  ...
  return (
    <div className="flex-col   flex bg-gray-100 gap-4 rounded-md p-4 m-3 ">
    ...
    <label className="flex flex-col rounded-lg   w-full group text-center">
              ...
              color="purple"
              onClick={upload}
              className="button-submit my-2 rounded-md  font-bold bg-primaryMain dark:bg-secondary cursor-pointer flex justify-between  items-center "
            >
              Upload 
            </Button>
      {/* <input
