  ...
  return (
    <div className="flex bg-slate-50 dark:text-white dark:bg-darkBgMain flex-col gap-20 py-20 justify-center items-center">
      <div className=" relative flex  flex-col   justify-center  gap-2">
        <p className="tracking-[2px] font-semibold dark:text-secondary text-primaryMain m-1 uppercase">
          {blog1?.Category}
        </p>
        <h1 className=" font-bold leading-[75px] text-[65px] font-serif capitalize">
          {blog1?.Title}{" "}
        </h1>
      </div>
